      ...
      <div className="modal-content">
        ...
        <div className="form-section">
          ...
          <div className="form-item">
            ...
            <Input
              placeholder={t('createCollection.collectionTitlePlaceholder')}
              value={title}
          ...
          <div className="form-item">
            <div className="form-label">
              ...
              <Text strong>{t('createCollection.collectionDescription')}</Text>
            </div>
            <TextArea
              placeholder={t('createCollection.collectionDescPlaceholder')}
              value={summary}
            ...
            <div className="clips-selection">
              <div className="selection-header">
                <Text className="selection-info">
                  {t('createCollection.selectedCount', { count: selectedClips.length })}
                </Text>
                  ...
                  >
                    ...
                    <div className="clip-content">
                      <div className="clip-title">
                        {clip.generated_title || clip.title || t('common.unnamedClip')}
                      </div>
                      <div className="clip-meta">
                        <Text type="secondary" style={{ fontSize: '12px' }}>
                          {clip.start_time} - {clip.end_time} • {t('createCollection.scoreDisplay', { score: (clip.final_score * 100).toFixed(0) })}
                        </Text>
                      </div>
                    </div>
                  </div>
